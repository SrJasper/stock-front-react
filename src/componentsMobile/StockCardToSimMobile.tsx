...
const Card = ({ stock, handleClose }: Props) => {
  ...
  async function simStock() {
    ...
    setLoading(true);
    await axios.post(
      "https://stock-project-seven.vercel.app/stocks/newsim",
      data,
      ...
      <li className="mobile-buy-card ol-blocker">
        <div className="mobile-upper-info use-width">
          <div className="mobile-stock-name">
            <label className="mobile-stock-long-name">
              {" "}
              {stock.LongName.slice(0, 20)}
            </label>
          ...
          <div className="mobile-stock-name">
            ...
            <span className="value-new-stock">
              <p className="mobile-symbol-font">
        ...
        <div className="mobile-new-stock-buttons">
          <button
            className="buy-button green-button use-width"
          ...
          <div className="alternative-buttons use-width">
            <button
              className="register-stock-button use-width"
              onClick={() => {
                handleOpenRegisterCard &&
