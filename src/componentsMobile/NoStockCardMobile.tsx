  ...
  return (
    <div className='use-width'>
      <div className='mobile-no-stock-card'>
        ...
        <hr className='mobile-padding-line'/>
        <h2>Sobre o site</h2>
        <p>
        ...
        <hr className='mobile-gap-line black'/>
        <div className='mobile-horizontal-texts'>
          <div>
            ...
            <h2 className='blue-text margin-top'>Registro</h2>
            <p>
